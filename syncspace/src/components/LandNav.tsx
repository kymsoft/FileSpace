  ...
  return (
    ...
    >
      <nav className="flex flex-between w-full py-5 px-10">
        <div>
          <Link href="/" className="flex gap-2 flex-center">
            <Image
              ...
              className=""
            />
            <p className="logo_text mt-1 text-2xl">SyncSpace</p>
          </Link>
        </div>

        <div className="flex gap-5 flex-center justify-center ml-12 mt-3 nav_text hidden md:block">
        ...
        {isClick && (
          <div className="md:hidden ml-auto w-full mt-10 p-4 rounded-md absolute left-0 right-0 bg-[#0D1117] shadow-md transition-all duration-1000 ease-in-out max-h-96 overflow-y-auto">
